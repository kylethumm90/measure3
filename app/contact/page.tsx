...
export default function ContactPage() {
  ...
  const inputClasses =
    "border-subtle w-full rounded-lg bg-white px-3.5 py-2.5 text-sm text-[#1a1a1a] outline-none focus:ring-2 focus:ring-[#B8860B]/20";
      ...
      <div className="mx-auto max-w-lg px-5">
        ...
        <form onSubmit={handleSubmit} className="mt-10 flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 rounded-lg bg-[#B8860B] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#A07608] disabled:opacity-50"
          >
